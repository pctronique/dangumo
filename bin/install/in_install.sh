...
FOLDER_PROJECT_ANGULAR_1="$(tr '[:lower:]' '[:upper:]' <<< ${FOLDER_PROJECT_ANGULAR:0:1})${FOLDER_PROJECT_ANGULAR:1}"
NAME_PROJECT_1="$(tr '[:lower:]' '[:upper:]' <<< ${NAME_PROJECT:0:1})${NAME_PROJECT:1}"

INDEX_LINE1="<title>$FOLDER_PROJECT_ANGULAR_1<\/title>"
...
README_LINE1="# $FOLDER_PROJECT_ANGULAR_1"
...
APP_TS_LINE1="title = '$FOLDER_PROJECT_ANGULAR';"
APP_TS_LINE1_REPLACE="title = '$NAME_PROJECT';"
APP_TS_FILE="${0%/*}/../../project/$FOLDER_PROJECT_ANGULAR/src/app/app.component.ts"
sed -i "s/$APP_TS_LINE1/$APP_TS_LINE1_REPLACE/" $APP_TS_FILE

APP_SPEC_LINE1="$FOLDER_PROJECT_ANGULAR"
APP_SPEC_LINE1_REPLACE="$NAME_PROJECT"
APP_SPEC_FILE="${0%/*}/../../project/$FOLDER_PROJECT_ANGULAR/src/app/app.component.spec.ts"
sed -i "s/$APP_SPEC_LINE1/$APP_SPEC_LINE1_REPLACE/" $APP_SPEC_FILE

ANGU_JSON_LINE1="$FOLDER_PROJECT_ANGULAR"
ANGU_JSON_LINE1_REPLACE="$NAME_PROJECT"
ANGU_JSON_FILE="${0%/*}/../../project/$FOLDER_PROJECT_ANGULAR/angular.json"
sed -i "s/$ANGU_JSON_LINE1/$ANGU_JSON_LINE1_REPLACE/" $ANGU_JSON_FILE

PACK_JSON_LINE1="$FOLDER_PROJECT_ANGULAR"
PACK_JSON_LINE1_REPLACE="$NAME_PROJECT"
PACK_JSON_FILE="${0%/*}/../../project/$FOLDER_PROJECT_ANGULAR/package.json"
